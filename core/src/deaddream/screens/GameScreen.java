...
public class GameScreen implements Screen {
	...
	public void show() {
		...
		Texture UCMothershipTexture = game.assets.get("skins/units/materinskiy2.png", Texture.class);
		UCMothershipTexture.setFilter(TextureFilter.Linear, TextureFilter.Linear);

		Texture UCMothershipNormalTexture = game.assets.get("skins/units/materinskiyNormal2.png", Texture.class);
