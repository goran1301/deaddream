 ...
 * @author davedes
 */
public class DIllumination2 implements ApplicationListener {	
	...
	public void create() {
		...
		texture = new Texture(Gdx.files.internal("skins/units/stone.png"));
		texture_n = new Texture(Gdx.files.internal("skins/units/stoneNormal.png"));
		
		flipY = false;//texture==rock;
	...
	public static void main(String[] args) {
		...
		new LwjglApplication(new DIllumination2(), cfg);
	}
}
